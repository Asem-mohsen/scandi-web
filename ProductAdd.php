    ...
    <div class="Switcher" id="productType">
      ...
      <div class="hidden">
        <div id="hidden_div1">
          ...
          <input type="number" placeholder="Weight" id="weight" name="KG"> <span class="error2"> <?php if (isset($KGErr)) echo "* ", $KGErr;
                                                                                      ?></span>
          <p>
        ...
        <div id="hidden_div2">
          ...
          <input type="number" placeholder="Size" id="size" name="MB"> <span class="error2"> <?php if (isset($MBErr)) echo "* ", $MBErr;
                                                                                    ?></span>
          <p>
        ...
        <div id="hidden_div3">
          ...
          <div class="inputs" style=" position: relative; bottom: 58px;top: -94px;">
            <input type="number" placeholder="Hight" id="hight" name="H"><span class="error3" onkeydown="javascript: return event.keyCode == 69 ? false : true"> <?php if (isset($HErr)) echo "* ", $HErr;
                                                                                                ?></span>
            <input type="number" placeholder="Width" id="width" name="W"><span class="error3" onkeydown="javascript: return event.keyCode == 69 ? false : true"> <?php if (isset($WErr)) echo "* ", $WErr;
                                                                                                ?></span>
            <input type="number" placeholder="Length" id="length" name="L"><span class="error3" onkeydown="javascript: return event.keyCode == 69 ? false : true" > <?php if (isset($LErr)) echo "* ", $LErr;
                                                                                                  ?></span>
          </div>
          <div class="text2">
            <p>
